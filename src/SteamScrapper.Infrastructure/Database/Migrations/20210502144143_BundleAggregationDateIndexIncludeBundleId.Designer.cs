...
namespace SteamScrapper.Infrastructure.Database.Migrations
{
    ...
    [Migration("20210502144143_BundleAggregationDateIndexIncludeBundleId")]
    partial class BundleAggregationDateIndexIncludeBundleId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SteamScrapper.Infrastructure.Database.Entities.BundleAggregation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("UtcDateTimeRecorded")
                        .HasAnnotation("SqlServer:Include", new[] { "BundleId" });

                    b.ToTable("BundleAggregations");
                });

            modelBuilder.Entity("SteamScrapper.Infrastructure.Database.Entities.BundlePrice", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SteamScrapper.Infrastructure.Database.Entities.SubAggregation", b =>
                {
                    ...
                    b.HasIndex("UtcDateTimeRecorded")
                        .HasAnnotation("SqlServer:Include", new[] { "SubId" });
            ...
            modelBuilder.Entity("SteamScrapper.Infrastructure.Database.Entities.BundleAggregation", b =>
                {
                    b.HasOne("SteamScrapper.Infrastructure.Database.Entities.Bundle", "Bundle")
